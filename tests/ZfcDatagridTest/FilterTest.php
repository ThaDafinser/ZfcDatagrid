...
class FilterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDefaultOperator ()
    {
        ...
        $this->assertEquals('test', $filter->getValue()[0]);
    ...
    public function testIn ()
    {
        ...
        //@todo wrong?
        $this->assertEquals('test,test2', $filter->getValue()[0]);
    }
    ...
    public function testBetween ()
    {
        ...
        $this->assertEquals('2', $filter->getValue()[0]);
        $this->assertEquals('3', $filter->getValue()[1]);
    }
}
